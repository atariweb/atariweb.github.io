import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { getCurrentInstance, readonly, computed, inject, shallowRef, toRef, isRef, hasInjectionContext, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, ref, Suspense, Fragment, useSSRContext, createApp, createVNode, Text, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, mergeProps, withCtx, getCurrentScope, nextTick } from 'vue';
import { y as sanitizeStatusCode, z as getContext, $ as $fetch$1, A as createHooks, B as executeAsync, n as createError$1, C as toRouteMatcher, D as createRouter$1, E as defu, F as getRequestURL, G as getRequestHeader, H as parse$1, d as destr, I as klona, J as isEqual$1, K as setCookie, L as getCookie, M as deleteCookie } from '../_/nitro.mjs';
...
import { ssrRenderSlotInner, ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const _routes = [
  {
    name: "index___en",
    path: "/",
    component: () => import('./index-Cg98r_r4.mjs')
  },
  {
    name: "index___fa",
    path: "/fa",
  ...
  {
    name: "singleBlog-slug___en",
    path: "/singleBlog/:slug(.*)*",
    component: () => import('./_...slug_-3f2KvQNK.mjs')
  },
  {
    name: "singleBlog-slug___fa",
    path: "/fa/singleBlog/:slug(.*)*",
    component: () => import('./_...slug_-3f2KvQNK.mjs')
  }
];
...
const vueI18nConfigs = [
  () => import(
    './i18n.config-DM3tgmS6.mjs'
    /* webpackChunkName: "config_i18n_46config_46ts_d644ed63" */
  )
];
...
const layouts = {
  "auth-layout": defineAsyncComponent(() => import('./AuthLayout-CfMkC8nB.mjs').then((m) => m.default || m)),
  footer: defineAsyncComponent(() => import('./Footer-6g090y55.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-DMgth_tO.mjs').then((m) => m.default || m))
};
...
function useGlobalLoading() {
  const loadingState = useState("globalLoading", () => ({
    isLoading: true,
    // Start with loading active
    type: "page",
    message: "در حال بارگذاری...",
    operations: /* @__PURE__ */ new Set(["initial-loading"])
  }));
  ...
  const setLoading = (isLoading2, type = "general", message) => {
    if (isLoading2) {
  ...
  const setPageLoading = (isLoading2, message) => {
  ...
  const setLanguageLoading = (isLoading2, message) => {
  ...
  const setThemeLoading = (isLoading2, message) => {
...
const PageTransition = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-dbb61306"]]), { __name: "PageTransition" });
const _sfc_main$2 = {
  __name: "app",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isLoading)) {
        _push(`<div class="fixed inset-0 z-[9999] flex items-center justify-center modern-blur-overlay"><div class="absolute inset-0 modern-blur-bg"></div><div class="relative z-10 modern-clean-spinner"><div class="spinner-ring"></div><div class="spinner-ring"></div><div class="spinner-ring"></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(ssrRenderComponent(_component_NuxtLayout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(PageTransition, { name: "fade" }, {
            ...
            return [
              createVNode(PageTransition, { name: "fade" }, {
                default: withCtx(() => [
                  createVNode(_component_NuxtPage)
                ]),
                _: 1
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BaX4xvG9.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D8ndPwd4.mjs'));
...
export { _export_sfc as _, useI18n as a, useTheme as b, useSeoMeta as c, useRouter as d, entry$1 as default, useNuxtApp as e, useRuntimeConfig as f, withoutTrailingSlash as g, hasProtocol as h, nuxtLinkDefaults as i, joinURL as j, useLocalePath as k, useGlobalLoading as l, navigateTo as n, parseQuery as p, resolveRouteObject as r, useHead as u, withTrailingSlash as w };
